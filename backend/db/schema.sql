...
CREATE TABLE IF NOT EXISTS products (
    ...
    source          TEXT        CHECK (source IN ('off', 'obf', 'user', 'image_scan', 'usda', 'openfda', 'upcitemdb', 'dailymed')),
...
COMMENT ON COLUMN products.source          IS 'off=Open Food Facts, obf=Open Beauty Facts, user=submitted, image_scan=extracted by agent, usda=USDA FoodData, openfda=OpenFDA OTC, upcitemdb=UPCitemdb barcode fallback, dailymed=DailyMed Rx drugs.';
